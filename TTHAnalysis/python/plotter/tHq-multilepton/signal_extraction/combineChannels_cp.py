...
def main(args, options):
    ...
    chans = {
        1 : None,
        2 : ['tHq_2lss_mm_cp','tHq_3l_cp'],
        3 : ['tHq_2lss_mm_cp','tHq_2lss_em_cp','tHq_3l_cp'],
        4 : ['tHq_2lss_mm_cp','tHq_2lss_em_cp','tHq_2lss_ee_cp','tHq_3l_cp'],
    }[len(inputdirs)]
    if chans == None:
    ...
    for cards in zip(*tuple([dn2cards[d] for d in inputdirs])):
        ...
        tagpat = re.compile(r'.*\_([\cp]+\_[\dpm]+)\.card\.txt')
